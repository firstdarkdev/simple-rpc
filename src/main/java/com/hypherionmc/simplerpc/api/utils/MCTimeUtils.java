 ...
 * @author HypherionSA
 *
 * Helper class to format MC time to readable human format
 *
 * I honestly do not remember where I found this class, or what its license is.... It's been ages since it's been included
 */
