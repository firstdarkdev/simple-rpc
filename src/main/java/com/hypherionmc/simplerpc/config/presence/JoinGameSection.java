...
public final class JoinGameSection implements RichPresenceContainer {
    ...
    public RandomArrayList<String>  description = RandomArrayList.of("{{player.name}} is joining a game");

    @Path("state")
    @SpecComment("The second line of text under the app name")
    public RandomArrayList<String>  state = RandomArrayList.of("Joining Game");
