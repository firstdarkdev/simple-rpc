 ...
 * @author HypherionSA
 *
 * Main RPC that is shown while the player is in the main menu
 */
public final class MainMenuSection implements RichPresenceContainer {

    @Path("enabled")
    @SpecComment("Enable/Disable the Main Menu Event")
    public boolean enabled = true;

    @Path("description")
    @SpecComment("The first line of text under the app name")
    public RandomArrayList<String>  description = RandomArrayList.of("{{player.name}} is currently lazy");

    @Path("state")
    @SpecComment("The seconds line of text under the app name")
    public RandomArrayList<String>  state = RandomArrayList.of("Chilling in the menu");
    ...
    public RandomArrayList<String>  largeImageText = RandomArrayList.of();

    @Path("smallImageKey")
    @SpecComment("The Asset ID of the image to display as the small image")
    @HideFromScreen
    public RandomArrayList<String> smallImageKey = RandomArrayList.of("{{images.player}}");

    @Path("smallImageText")
    @SpecComment("The text that gets displayed when the small image is hovered")
    public RandomArrayList<String>  smallImageText = RandomArrayList.of( "{{player.name}}");
