...
publisher {
    ...
    displayName.set("[1.18.2 - 26.1] Simple RPC Universal ${project.version}")
    setGameVersions("1.18.2", "1.19.2", "1.20", "1.20.1", "1.21", "1.21.1", "1.21.2", "1.21.3", "1.21.4", "1.21.5", "1.21.6", "1.21.7", "1.21.8", "1.21.9", "1.21.10", "1.21.11", "26.1")
